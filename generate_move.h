...
const unsigned char horse_check[4]={+1,+1,+16,-16,+16,-16,-1,-1};
...
void generate_adviser_move(unsigned char curr_chess_board[],int depth,int* count,movement move_array[][128]);
void generate_elephant_move(unsigned char curr_chess_board[],int depth,int* count,movement move_array[][128]);
void generate_horse_move(unsigned char curr_chess_board[],int depth,int* count,movement move_array[][128]);
void generate_charoit_move(unsigned char curr_chess_board[],int depth,int* count,movement move_array[][128]);
void generate_canon_move(unsigned char curr_chess_board[],int depth,int* count,movement move_array[][128]);
void generate_r_pawn_move(unsigned char curr_chess_board[],int depth,int* count,movement move_array[][128]);
void generate_b_pawn_move(unsigned char curr_chess_board[],int depth,int* count,movement move_array[][128]);
